...
import 'package:Snake2D/game_over.dart';
...
class _GamePageState extends State<GamePage> with TickerProviderStateMixin {
      ...
      setState(() {
        ...
        if (_gameOver()) {
          ...
          Navigator.of(context).pushReplacement(
              MaterialPageRoute(builder: (context) => GameOver(score: _playerScore)));
        }
      });
    }
  }

  void _changeDirection(String direction) {
    setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Snake2D', style: TextStyle(color: Colors.white, fontSize: 20.0)),
        centerTitle: false,
